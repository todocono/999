...
<body>
    ...
    <div class="textContainer">
        <p id="msgReceived1">loading</p>
        <p id="msgReceived2">loading</p>
        <p id="msgReceived3">loading</p>
    </div>
    ...
    <script>
            ...
            function connect() {
                ...
                websocket.onclose = function (event) {
                    ...
                    setTimeout(function () {
                        ...
                        document.getElementById('msgReceived1').innerHTML = "<br>";
                        document.getElementById('msgReceived3').innerHTML = "<br>";
                ...
                websocket.onmessage = function (event) {
                    if (event.data == "1") {
                        document.getElementById('msgReceived1').innerHTML = "";
                        document.getElementById('msgReceived2').innerHTML = "";
                        document.getElementById('msgReceived3').innerHTML = "";
                    }
                    else if (event.data == "ALIVE") {
                    } else {
                        if (event.data.length <= 6) {
                            console.log(event.data.length > 5);
                            document.getElementById('msgReceived1').innerHTML = "<br>";
                            document.getElementById('msgReceived2').innerHTML = event.data;
                            document.getElementById('msgReceived3').innerHTML = "<br>";
                        } else {
                            document.getElementById('msgReceived1').innerHTML = event.data;
                            document.getElementById('msgReceived2').innerHTML = "";
                            document.getElementById('msgReceived3').innerHTML = "";
                        }
        ...
        document.onkeypress = function (e) {
            e = e || window.event;
            // use e.keyCode
            document.getElementById('msgReceived2').innerHTML = e.keyCode;
        };
